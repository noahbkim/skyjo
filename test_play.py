...
def test_get_skyjo_symmetries():
    ...
    # --- Generate Symmetries ---
    symmetries = play.get_skyjo_symmetries(skyjo_state, policy)
    ...
    expected_target_policy = play.get_symmetry_policy(policy, target_p0_perm)
...
def test_get_symmetry_policy():
    ...
    actual = play.get_symmetry_policy(original_policy, column_order)
